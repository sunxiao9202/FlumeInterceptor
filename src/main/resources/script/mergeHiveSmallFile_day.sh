...
set mapreduce.job.name=ods.cc_studied_lesson_log_day;
create table if not exists ods.cc_studied_lesson_log_day(
Id int COMMENT '自增ID',
...
insert overwrite table ods.cc_studied_lesson_log_day 
select Id,USER_ID,RECRUIT_ID,LESSON_ID,LESSON_VIDEO_ID,VIDEO_ID,PLAY_TIMES,STUDY_TOTAL_TIME,LEARN_TIME,SOURSE_TYPE,CREATE_TIME from ods.cc_studied_lesson_log
where PARTITION_TIME='20200205';
